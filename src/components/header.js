        ...
        render = { data => 
            <header className={styles.container}>
                <div className={styles.row}>
                    ...
                    <SocialButton site="github" username="umreen24"></SocialButton>
                    <SocialButton site="linkedin" username="umreen-imam"></SocialButton>
                    <SocialButton site="twitter" username="umreeny24"></SocialButton>
                </div>
